	      ...
	      menuItem.addSelectionListener(new SelectionAdapter() {
	         public void widgetSelected(SelectionEvent e) {
	        	 ...
	        	 try {
	            	...
	            	write= new FileWriter("C:/Users/jnallou/Desktop/Mod Software Dev Methodologies/workspaceCSCI8710/workspaceCSCI8710-Allou/project-x-0917-ast-table-allou/output.csv");
